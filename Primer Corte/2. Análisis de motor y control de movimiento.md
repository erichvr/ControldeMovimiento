...
[3][4][5][7] H. Gürocak, Industrial Motion Control: Motor Selection, Drives, Controller Tuning, Applications. John Wiley & Sons, Ltd., 2016.
[6] IMEPI México, ¿Que es una Interfaz Humano-Máquina (HMI)? , IMEPI Mexico, 2024.
[8] Academia de PLC, "Sistema de control de movimiento", Academia de PLC, 2022.
