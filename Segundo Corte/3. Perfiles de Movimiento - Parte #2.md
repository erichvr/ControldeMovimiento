...
| ![Perfil de Posición, Velocidad, Aceleración y Golpeteo de la Curva Pura S.](https://github.com/user-attachments/assets/0a325dd2-1763-48de-aa1a-8d398b6d9cef) Figura 1. Perfil de Posición _s(t)_, Velocidad _v(t)_, Aceleración _a(t)_ y Golpeteo _j(t)_ de la Curva Pura S de _v(t)_. | ![Perfil de Posición, Velocidad, Aceleración y Golpeteo de la Curva Pura S.](https://github.com/user-attachments/assets/d47f865e-ed58-41d0-a87c-79306895141c) Figura 2. Perfil de Posición _s(t)_, Velocidad _v(t)_, Aceleración _a(t)_ y Golpeteo _j(t)_ de la Curva Pura S de _v(t)_. |
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
