...
Continuando con la temática de perfiles de movimiento, en la clase de hoy se presentó otro perfil de movimiento llamado Curva en S y Curva pura en S, se realizó el modelamiento matemático y se explicó su análisis usando cálculos y usando MATLAB. Posteriormente
## 1. Perfiles de movimiento comunes
### 1.2. Curva en S
### 1.3. Graficación de los perfiles en MATLAB
